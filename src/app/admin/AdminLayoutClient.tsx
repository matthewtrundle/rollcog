...
/**
 * @fileoverview Admin layout client component with dark theme and navigation
 * @module app/admin/AdminLayoutClient
 */
...
export default function AdminLayoutClient({ children }: AdminLayoutProps): ReactElement {
                  ...
                  <Link
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
                      isActive
                        ...
                        : "!text-white opacity-90 hover:opacity-100 hover:bg-gray-700/50"
                    }`}
                  >
