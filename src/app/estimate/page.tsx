        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="animate-fade-in-up">
              ...
              {/* Feature highlight */}
              <div className="mt-6 flex items-center gap-3 bg-[var(--accent)]/10 border border-[var(--accent)]/20 px-4 py-2.5 rounded-xl w-fit">
              ...
              {/* Hero Image */}
              <div className="mt-8 relative rounded-2xl overflow-hidden shadow-2xl">
