        ...
        <div className="fixed bottom-4 right-4 z-50">
          ...
          {!isExpanded && (
            ...
            >
              ...
              {/* Pulse animation - limited iterations to reduce CPU usage */}
              <span className="absolute -inset-1 rounded-full bg-[var(--accent)] animate-ping opacity-20 pointer-events-none [animation-iteration-count:3]" />
            </motion.div>
          )}
        </div>
      )}
